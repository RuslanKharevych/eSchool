...
import ifntuog.eschool.model.Lesson;
...
public interface LessonRepository extends JpaRepository<Lesson, Integer> {
    /**
     * Returns list of Map objects that contain data about one {@link ifntuog.eschool.dto.DiaryEntryDTO}}.
     * @param studentId student's id
     * @param startDate first day of period
     * @param endDate last day of period
     * @return list of Map objects that contain data about one {@link ifntuog.eschool.dto.DiaryEntryDTO}}.
     */
    ...
    /**
     * Returns a list of {@link ifntuog.eschool.model.Lesson}}
     * @param idSubject   id of the subject
     * @param idClass    id of the class
     * @return          list of {@link ifntuog.eschool.model.Lesson} objects that contains homeworks of
    ...
    /**
     * Returns a list of Map objects that contains data about {@link ifntuog.eschool.dto.ScheduleDTO}}
     ...
     *                  that is represented as a list of {@link ifntuog.eschool.dto.SubjectDTO}.
     */
    ...
    /**
     * Returns a {@link ifntuog.eschool.model.Lesson} object that contains information about file}
