package ifntuog.eschool.dto;

import io.swagger.annotations.ApiModel;
import io.swagger.annotations.ApiModelProperty;
import lombok.*;

import static ifntuog.eschool.model.Subject.SUBJECT_NAME_PATTERN;
...
public class LessonDTO {
    ...
    @ApiModelProperty(required = true, notes = "Contains the number of the lesson.")
