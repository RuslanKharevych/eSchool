...
import ifntuog.eschool.repository.LessonRepository;
import ifntuog.eschool.service.ScheduleServiceImpl;
...
public class ScheduleController {
    ...
    /**
     * This POST method creates a schedule for a specific class with id {@link ifntuog.eschool.dto.ClassDTO#id}.
     * Before saving a schedule, the method checks if a schedule with this bounds already exists:
     * <ol>
     *     <li>
     *      If it exists and there are not marks putted on this dates {@link ifntuog.eschool.model.Mark#lesson},
