...
import ifntuog.eschool.service.ClassTeacherSubjectServiceImpl;
...
public class TeacherJournalController {
     ...
     * @param teacherId     id of the teacher {@link ifntuog.eschool.dto.TeacherDTO#id}
     * @param classId       id of the class {@link ifntuog.eschool.dto.ClassDTO#id}
     * @param subjectId     id of the subject {@link ifntuog.eschool.dto.SubjectDTO#subjectId}
