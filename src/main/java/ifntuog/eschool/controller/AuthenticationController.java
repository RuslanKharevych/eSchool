package ifntuog.eschool.controller;
...
import ifntuog.eschool.security.JwtAuthenticationRequest;
import ifntuog.eschool.security.JwtTokenUtil;
import ifntuog.eschool.security.JwtUser;
import ifntuog.eschool.security.exceptions.TokenGlobalTimeExpiredException;
import ifntuog.eschool.service.PasswordResetService;
import ifntuog.eschool.wrapper.GeneralResponseWrapper;
import ifntuog.eschool.wrapper.Status;
...
public class AuthenticationController {
    ...
    /**
     * Returns {@link ifntuog.eschool.wrapper.GeneralResponseWrapper} with token if credentials are right
     * This endpoint isn't secured
     * @param authenticationRequest Object with username and password
     * @return Jwt token wrapped in {@link ifntuog.eschool.wrapper.GeneralResponseWrapper}
     */
    @PostMapping("signin")
    ...
    /**
     * Returns {@link ifntuog.eschool.wrapper.GeneralResponseWrapper} with token if authorization header is correct
